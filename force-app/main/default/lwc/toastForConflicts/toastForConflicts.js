    ...
    ensureSubscription() {
        if (!this.subscription) {
            ...
            subscribe(this.channelName, replayId, (message) => {
                ...
                console.log('Received Platform Event:', JSON.stringify(payload, null, 2));
                ...
                console.log('payload.UserId__c:', payload.UserId__c);
                console.log('USER_ID:', USER_ID);
                console.log('flag:', payload.is_Promotion_Conflcit_Resolved__c);
                console.log('payload.RecordId__c:', payload.RecordId__c);
                console.log('this.recordId:', this.recordId);*/
                if (payload.UserId__c && payload.UserId__c.substring(0, 15) === USER_ID.substring(0, 15) && payload.RecordId__c === this.recordId && payload.is_Promotion_Conflcit_Resolved__c === true) {
